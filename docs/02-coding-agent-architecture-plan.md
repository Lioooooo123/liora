...
> 技术选型决策见 [03-tech-stack-selection.md](./03-tech-stack-selection.md)，逐项实现记录见 [implementation-notes.md](../implementation-notes.md)。
...
主力终端 UI 采用 Go 原生实现，与 core 同进程、同语言、同二进制，无额外运行时依赖。这是相对早期「Ink + React + TypeScript」设想的有意调整（决策见 [03-tech-stack-selection.md](./03-tech-stack-selection.md) 与 [implementation-notes.md](../implementation-notes.md)）。
...
- [01-liora-1.0-plan.md](./01-liora-1.0-plan.md) — 1.0 主路线
- [03-tech-stack-selection.md](./03-tech-stack-selection.md) — 技术选型决策
- [04-v0.1-exit-audit.md](./04-v0.1-exit-audit.md) — v0.1 验收矩阵
