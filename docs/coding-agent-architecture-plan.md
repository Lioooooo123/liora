...
- **llm** ([internal/llm](../internal/llm))：多供应商 client（deepseek/openai-chat/openai-responses/anthropic/gemini）+ 自然语言 planner。
...
供 `apps/cli`、CLI 自动化和 Go 侧复用，覆盖 health、capabilities、task CRUD、单/多任务 SSE、diff、apply、cancel、approval、sessions、timeline、memories。
...
- [mvp-exit-benchmark.md](./mvp-exit-benchmark.md) — MVP 结束基准
- [v0.1-exit-audit.md](./v0.1-exit-audit.md) — v0.1 验收矩阵
- [tui-agent-parity-plan.md](./tui-agent-parity-plan.md) — TUI / agent 能力对标
