...
- UI 最小要求是“能解释状态、展示进度、允许独立预览 diff、允许 apply/cancel”；二次元视觉、白板和 Mac 原生体验进入 v0.2。
