...
- daemon API 覆盖健康检查、capabilities、创建任务、按 workspace 查询任务、查询事件、SSE、diff、apply、cancel、approval、session/history/timeline；Go daemon client 需要覆盖多 task event fan-in；capabilities 需要包含内建工具和可用 MCP 工具。
