...
(
  ...
  GOTOOLCHAIN="$GO_TOOLCHAIN" go test -count=1 ./internal/agent -run 'TestToolLoopStopsAtMaxTurns|TestToolLoopStopsOnRepeatedIdenticalFailingToolCall|TestToolLoopAllowsRepeatedShellCommandWhenFailureOutputChanges|TestToolLoopStopsOnRepeatedLargeFailingToolOutput|TestToolLoopPersistsLargeToolOutputForModel'
