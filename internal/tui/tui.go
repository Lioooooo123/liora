...
func RenderWelcome(config Config) string {
	...
	commands := mutedStyle.Render("Commands  /help  /tools  /workbench  /tasks  /sessions  /timeline  /transcript  /last  /tail  /diff  /approvals  /resume  /resume-session  /resume-latest  /new-session  /approve  /deny  /apply  /cancel  /exit")
	return header + "\n" + status + "\n\n" + commands + "\n"
}
