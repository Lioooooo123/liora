...
func ValidateEvent(eventType EventType, payload EventPayload) error {
	...
	case EventTodoUpdated, EventTranscriptEntry, EventArtifactReference, EventCompactBoundary, EventHookRun, EventScheduleTriggered, EventSubagentStarted, EventSubagentCompleted:
